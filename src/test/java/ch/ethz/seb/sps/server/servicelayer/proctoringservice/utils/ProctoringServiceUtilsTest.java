...
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.CLIENT_IP;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.CLIENT_MACHINE_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.CLIENT_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.CLIENT_OS_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.CLIENT_VERSION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.CREATION_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EMPTY_STRING;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.END_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EXAM_DESCRIPTION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EXAM_ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EXAM_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EXAM_TYPE;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EXAM_URL;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.EXAM_UUID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.GENERIC_LONG;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.GROUP_DESCRIPTION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.GROUP_ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.GROUP_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.GROUP_UUID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.IMAGE_FORMAT_PNG;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.IMAGE_ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.IMAGE_LINK;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.LAST_UPDATE_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.METADATA_APPLICATION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.METADATA_BROWSER;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.METADATA_URL;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.METADATA_USER_ACTION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.METADATA_WINDOW_TITLE;
...
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.NUMBER_OF_LIVE_SESSIONS;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.NUMBER_OF_LIVE_SESSIONS_EMPTY;
...
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.NUMBER_OF_SESSIONS_EMPTY;
...
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.START_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.TERMINATION_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.TIMESTAMP;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.UUID1;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstantsTest.UUID_LIST;

public class ProctoringServiceUtilsTest {
