...
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.CLIENT_IP;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.CLIENT_MACHINE_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.CLIENT_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.CLIENT_OS_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.CLIENT_VERSION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.CREATION_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EMPTY_STRING;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.END_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EXAM_DESCRIPTION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EXAM_ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EXAM_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EXAM_TYPE;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EXAM_URL;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.EXAM_UUID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.GENERIC_LONG;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.GROUP_DESCRIPTION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.GROUP_ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.GROUP_NAME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.GROUP_UUID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.IMAGE_FORMAT_PNG;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.IMAGE_ID;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.IMAGE_LINK;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.LAST_UPDATE_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.METADATA_APPLICATION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.METADATA_BROWSER;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.METADATA_URL;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.METADATA_USER_ACTION;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.METADATA_WINDOW_TITLE;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.NR_OF_SCREENSHOTS;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.NUMBER_OF_LIVE_SESSIONS;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.NUMBER_OF_LIVE_SESSIONS_EMPTY;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.NUMBER_OF_SESSIONS;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.NUMBER_OF_SESSIONS_EMPTY;
...
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.START_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.TERMINATION_TIME;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.TIMESTAMP;
import static ch.ethz.seb.sps.server.servicelayer.proctoringservice.utils.ProctoringServiceConstants.UUID1;
