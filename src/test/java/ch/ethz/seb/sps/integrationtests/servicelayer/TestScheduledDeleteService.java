    ...
    public void i1_testRequestScheduledDelete() throws Exception {
        ...
        assertEquals(
                "ScheduledDelete{id=null, state=PENDING, deleteDueTime=1767222000000, scheduleTime=null, startTime=null, endTime=null, ownerUUID='super-admin', " +
                        "info=[ScheduledDeleteInfo{id=null, scheduledDeleteId=null, state=PENDING, examUUID='a33d1f74-d5f2-47a3-8993-dc4d813bd4e4', deletionInfo='{institutionId=1, group_1_name=test_group, name=test exam 01, startTime=1709890124393, group_1_uuid=3cfb99c0-34a5-4ffd-a11c-6d9790b3f24c, group_1_sessionCount=2, group_2_name=exam_group, group_2_sessionCount=1, supporter=06628f1f-8b2e-4bfa-8dd6-79842e7c0249,66c9c9d5-953a-44e2-a4d1-2348f7a7c489, group_2_uuid=1cfb88c0-34a5-4ffd-a11c-6d9790b3f24c}', errorInfo='null'}, " +
                        "ScheduledDeleteInfo{id=null, scheduledDeleteId=null, state=PENDING, examUUID='a33d1f74-d5f2-47a3-8993-dc4d813bd4e5', deletionInfo='{institutionId=1, name=test exam 02, startTime=1709890124394, supporter=super-admin,66c9c9d5-953a-44e2-a4d1-2348f7a7c489}', errorInfo='null'}, " +
                        "ScheduledDeleteInfo{id=null, scheduledDeleteId=null, state=PENDING, examUUID='a33d1f74-d5f2-47a3-8993-dc4d813bd4e6', deletionInfo='{institutionId=1, name=test exam 03, startTime=1709890124395}', errorInfo='null'}, ScheduledDeleteInfo{id=null, scheduledDeleteId=null, state=PENDING, examUUID='a33d1f74-d5f2-47a3-8993-dc4d813bd4e7', deletionInfo='{institutionId=1, name=test exam 04, startTime=1709890124396}', errorInfo='null'}]}",
    ...
    public void i2_testCreateScheduledDelete() throws Exception {
        ...
        assertEquals(
                "ScheduledDelete{id=1, state=PENDING, deleteDueTime=1767222000000, scheduleTime=2524604400000, startTime=null, endTime=null, ownerUUID='super-admin', " +
                        ...
                        "ScheduledDeleteInfo{id=2, scheduledDeleteId=1, state=PENDING, examUUID='a33d1f74-d5f2-47a3-8993-dc4d813bd4e5', deletionInfo='{institutionId=1, name=test exam 02, startTime=1709890124394, supporter=super-admin,66c9c9d5-953a-44e2-a4d1-2348f7a7c489}', errorInfo='null'}]}",
                created.toString());
