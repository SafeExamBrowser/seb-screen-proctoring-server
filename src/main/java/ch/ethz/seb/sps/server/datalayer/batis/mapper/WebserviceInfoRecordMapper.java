...
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.creationTime;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.id;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.lastUpdateTime;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.master;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.serverAddress;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.terminationTime;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.uuid;
import static ch.ethz.seb.sps.server.datalayer.batis.mapper.WebserviceInfoRecordDynamicSqlSupport.webserviceInfoRecord;
...
public interface WebserviceInfoRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-09-13T17:30:00.335+02:00", comments="Source Table: webservice_server_info")
