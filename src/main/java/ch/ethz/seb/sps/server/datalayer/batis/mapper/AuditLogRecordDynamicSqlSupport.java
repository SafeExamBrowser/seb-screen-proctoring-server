...
public final class AuditLogRecordDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.896+02:00", comments="Source Table: audit_log")
    public static final AuditLogRecord auditLogRecord = new AuditLogRecord();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.896+02:00", comments="Source field: audit_log.id")
    public static final SqlColumn<Long> id = auditLogRecord.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.896+02:00", comments="Source field: audit_log.user_uuid")
    public static final SqlColumn<String> userUuid = auditLogRecord.userUuid;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.896+02:00", comments="Source field: audit_log.timestamp")
    public static final SqlColumn<Long> timestamp = auditLogRecord.timestamp;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.896+02:00", comments="Source field: audit_log.activity_type")
    public static final SqlColumn<String> activityType = auditLogRecord.activityType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.896+02:00", comments="Source field: audit_log.entity_type")
    public static final SqlColumn<String> entityType = auditLogRecord.entityType;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.897+02:00", comments="Source field: audit_log.entity_id")
    public static final SqlColumn<Long> entityId = auditLogRecord.entityId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-15T14:43:27.897+02:00", comments="Source field: audit_log.message")
