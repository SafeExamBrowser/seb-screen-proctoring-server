...
public interface SEBClientAccessService {

    Logger log = LoggerFactory.getLogger(SEBClientAccessService.class);
    ...
    Result<RegisteredClient> getClientDetails(String clientName);
