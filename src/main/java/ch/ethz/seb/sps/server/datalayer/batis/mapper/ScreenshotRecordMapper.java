...
public interface ScreenshotRecordMapper {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-16T13:34:04.639+02:00", comments="Source Table: screenshot")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ConstructorArgs({
        @Arg(column="id", javaType=Long.class, jdbcType=JdbcType.BIGINT, id=true),
        @Arg(column="image", javaType=byte[].class, jdbcType=JdbcType.BLOB)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2023-08-16T13:34:04.640+02:00", comments="Source Table: screenshot")
