...
@Generated(value="org.mybatis.generator.api.MyBatisGenerator",comments="ch.ethz.seb.sps.generator.DomainModelNameReferencePlugin",date="2026-02-25T09:07:37.559+01:00")
public interface Domain {
    ...
    interface SCHEDULED_DELETE {
        String TYPE_NAME = "ScheduledDelete";
        String REFERENCE_NAME = "scheduledDeletes";
        String ATTR_ID = "id";
        String ATTR_STATE = "state";
        String ATTR_DELETE_DUE_TIME = "deleteDueTime";
        String ATTR_SCHEDULE_TIME = "scheduleTime";
        String ATTR_START_TIME = "startTime";
        String ATTR_END_TIME = "endTime";
        String ATTR_OWNER = "owner";
    }

    interface SCHEDULED_DELETE_INFO {
        String TYPE_NAME = "ScheduledDeleteInfo";
        String REFERENCE_NAME = "scheduledDeleteInfos";
        String ATTR_ID = "id";
        String ATTR_SCHEDULED_DELETE_ID = "scheduledDeleteId";
        String ATTR_STATE = "state";
        String ATTR_EXAM_UUID = "examUuid";
        String ATTR_DELETION_INFO = "deletionInfo";
        String ATTR_ERROR_INFO = "errorInfo";
    }
}